...
{
	/*¼ì²éÐÐ*/
	int count=1;								/*countÖÃ³õÖµ*/
	int i=x,j=y;
	j++;
	/*ÏòÓÒÊý*/
	while(j<N&&count<5)
	{
		if(status[i][j]==status[x][y])			/*ÅÐ¶ÏÊÇ·ñÓÐÂä×ÓÒÔ¼°ÊÇ·ñÎªÍ¬Ò»Íæ¼Ò*/
		{
			count++;
		}else									/*ÎÞÂä×Ó»ò²»ÊÇÍ¬Ò»Íæ¼Ò*/
		{
			break;								/*ÍË³öÑ­»·*/
		}
		j++;
	...
	/*Ïò×óÊý*/
	j=y-1;
	while(j>=0&&count<5)						/*ÍË³öÉÏÒ»¸öwhileÑ­»·Ê±countÐ¡ÓÚ5*/
	{
		if(status[i][j]==status[x][y])			/*ÅÐ¶ÏÊÇ·ñÓÐÂä×ÓÒÔ¼°ÊÇ·ñÎªÍ¬Ò»Íæ¼Ò*/
		{
		   count++;
	...
	if(count==5)								/*ÐÎ³ÉÎå×ÓÁ¬³ÉÒ»ÏßµÄ×´Ì¬*/
	{
	   return status[x][y];						/*·µ»Østatus[x][y]ÖÐµÄÖµ*/
	}
     /*¼ì²éÁÐ*/
	i=x;
	j=y;
	...
	/*ÍùÉÏÊý*/
	i=x-1;
	while(i>=0&&count<5)						/*ÍË³öÉÏÒ»¸öwhileÑ­»·Ê±countÐ¡ÓÚ5*/
	{
		if(status[i][j]==status[x][y])			/*ÅÐ¶ÏÊÇ·ñÓÐÂä×ÓÒÔ¼°ÊÇ·ñÎªÍ¬Ò»Íæ¼Ò*/
		{
		   count++;
	...
	i=x+1;
	j=y+1;
	while(i<N&&j<N&&count<5)					/*ÍË³öÉÏÒ»¸öwhileÑ­»·Ê±countÐ¡ÓÚ5*/
	{
		if(status[i][j]==status[x][y])			/*ÅÐ¶ÏÊÇ·ñÓÐÂä×ÓÒÔ¼°ÊÇ·ñÎªÍ¬Ò»Íæ¼Ò*/
		{
		   count++;
	...
	i=i-1;
	j=j+1;
	while(i>=0&&j<N&&count<5) 					/*ÅÐ¶ÏÊÇ·ñÓÐÂä×ÓÒÔ¼°ÊÇ·ñÎªÍ¬Ò»Íæ¼Ò*/
	{
	...
	i=x+1;
	j=y-1;
	while(i>=0&&j<N&&count<5)					/*ÍË³öÉÏÒ»¸öwhileÑ­»·Ê±countÐ¡ÓÚ5*/
	{
		if(status[i][j]==status[x][y])			/*ÅÐ¶ÏÊÇ·ñÓÐÂä×ÓÒÔ¼°ÊÇ·ñÎªÍ¬Ò»Íæ¼Ò*/
		{
		   count++;
	...
	return 0;									/*Î´ÐÎ³ÉÎå×ÓÁ¬³ÉÒ»ÏßµÄ×´Ì¬£¬·µ»Ø0*/
}
