...
import json
import datetime
from myspider007_xiecheng.items import Myspider007XiechengItem
import time
from xpinyin import Pinyin


class XiechengTrainSpider(scrapy.Spider):
    name = 'xiecheng_train'
    allowed_domains = ['ctrip.com']
    # start_urls = ['http://trains.ctrip.com/']

    def __init__(self):
        super(XiechengTrainSpider, self).__init__()
