...
class RedisMovieSpider(RedisSpider):
    name = 'redis_movie'
    # lpush redismoviespider:start_url http://movie.douban.com/top250
    redis_key = 'redismoviespider:start_url'
    ...
    def parse(self, response):
        ...
        if next_url:
            base_url = re.match(r"[^?]*", response.url).group()
            print(base_url)
