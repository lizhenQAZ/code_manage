    ...
    $.fn[pluginName] = function (options) {
        ...
        var pagination = {
            ...
            createTemplate: function (args) {
                ...
                var html = '';
                var goInput = '到第<input type="text" class="J-paginationjs-go-pagenumber" value="1">页';
                ...
                if (showPrevious || showPageNumbers || showNext) {
                    ...
                    if (showPrevious) {
                        if (currentPage === 1) {
                            if (!autoHidePrevious) {
                                html += '<li class="' + classPrefix + '-prev ' + disableClassName + '"><a>' + prevText + '上一页<\/a><\/li>';
                            }
                        }
                        else {
                            html += '<li class="' + classPrefix + '-prev J-paginationjs-previous" data-num="' + (currentPage - 1) + '" title="上一页"><a href="' + pageLink + '">' + prevText + '上一页<\/a><\/li>';
                        }
                    }
                    ...
                    if (showNext) {
                        if (currentPage == totalPage) {
                            if (!autoHideNext) {
                                html += '<li class="' + classPrefix + '-next ' + disableClassName + '"><a>下一页' + nextText + '<\/a><\/li>';
                            }
                        }
                        else {
                            html += '<li class="' + classPrefix + '-next J-paginationjs-next" data-num="' + (currentPage + 1) + '" title="下一页"><a href="' + pageLink + '">下一页' + nextText + '<\/a><\/li>';
                        }
                    }
            ...
            observer: function () {
                ...
                el.delegate('.J-paginationjs-go-button', 'click', function () {
                    ...
                    $('.J-paginationjs-go-pagenumber').val(pageNumber);
